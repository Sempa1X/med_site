...
def added():
    ...
    if len(data_replace[8][1]) < 11:
        phone2 = ''
    else:
        phone2 = data_replace[8][1]
    ...
    patient = Patient(full_name=full_name, patient_role=data_replace[0][1], surname=data_replace[1][1], first_name=data_replace[2][1], last_name=data_replace[3][1], birthday=data_replace[4][1],\
        ...
        lr_pass_date=data_replace[18][1], lr_pass_issued=data_replace[19][1], num_fetus=data_replace[20][1], estimated_birthday=data_replace[21][1], comment=data_replace[22][1])
