...
def search_process():
    ...
    if search:
        ...
        for i in patients_search:
            for o in i.records:
                patient_info.append({'full_name': i.full_name, 'comment': o.comment,'trust_factor': i.trust_factor, 'role': i.patient_role, 'phone': i.phone, 'records': {'id': o.id, 'is_active': o.isActive, 'doctor_full_name':o.doctor_full_name, 'date':o.date, 'time':o.time, 'office':o.office,  'doctor_id':o.doctor_id,}}) 
